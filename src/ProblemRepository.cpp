...
LoadResult ProblemRepository::loadFromFile(const std::string& filename) {
    LoadResult result;
    ...
    while (std::getline(file, line)) {
        ...
        try {
            ...
            if (problemExistsInVector(p, result.problems)) {
...
ImportResult ProblemRepository::importFromFile(
